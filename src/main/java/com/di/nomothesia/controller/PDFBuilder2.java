...
import com.di.nomothesia.service.impl.AbstractITextPdfView;
...
//                doc.add(new Chunk(line));
                ...
                //Title
                String title = legald.getTitle().replaceAll("<a href=\"(?s).*\">","").replaceAll("</a>", "");
                ...
                for (int w = 0; w<legald.getChapters().size(); w++) {
                    //String[] chap_letters = {"Α","Β","Γ","Δ","ΣΤ","","�","�","�","�","��","��","��","��","��","���","��","��","��"};
                    ...
                    //ID
                    String par2 = chap_header +" " + chap_letters[legald.getChapters().get(w).getId()-1] + "\n";
                    ...
                    if (legald.getChapters().get(w).getTitle() != null) {
                        String par3 = legald.getChapters().get(w).getTitle() + "\n";
                    ...
                    for (int i = 0; i<legald.getChapters().get(w).getArticles().size(); i++) {
                        ...
                        //Article id and title
                        //ID
                        par2 = article_header + " " + legald.getChapters().get(w).getArticles().get(i).getId() + "\n";
                        ...
                        if (legald.getChapters().get(w).getArticles().get(i).getTitle() != null) {
                            String par3 = legald.getChapters().get(w).getArticles().get(i).getTitle() + "\n";
                            Paragraph articlet = new Paragraph(par3, fontArticle);
                            articlet.setAlignment(Element.ALIGN_CENTER);
                            doc.add(articlet);
                        }
                        ...
                        for (int j = 0; j<legald.getChapters().get(w).getArticles().get(i).getParagraphs().size(); j++) {
                            ...
                            //get Paragraph id
                            paragraph3.add("" + legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getId() + ". ");

                            //get Passages
                            for (int k = 0; k<legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().size(); k++) {

                                String a = legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getText();
                                ...
                                if(legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getModification() != null) {
                                    ...
                                    if(legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getModification().getType().equals("Article")) {
                                        ...
                                        com.di.nomothesia.model.Article moda = (com.di.nomothesia.model.Article) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getModification().getFragment();
                                        ...
                                        com.di.nomothesia.model.Paragraph p = (com.di.nomothesia.model.Paragraph) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getModification().getFragment();
                                        ...
                                        Passage p = (Passage) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getModification().getFragment();
                            ...
                            for (int k = 0; k<legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().size(); k++) {
                                ...
                                //get Case Passage
                                for (int l = 0; l<legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getPassages().size(); l++) {

                                    String b = legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getPassages().get(l).getText();
                                ...
                                //Case in case
                                if (legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getCaseList() != null) {

                                    for (int p = 0; p<legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getCaseList().size(); p++) {
                                        ...
                                        //get Case Passage
                                        for (int l = 0; l<legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getCaseList().get(p).getPassages().size(); l++) {

                                            String c = legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getCaseList().get(p).getPassages().get(l).getText();
                                ...
                                if(legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification() != null) {
                                    ...
                                    if(legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification().getType().equals("Article")) {
                                        ...
                                        com.di.nomothesia.model.Article moda = (com.di.nomothesia.model.Article) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification().getFragment();
                                    ...
                                    else if(legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification().getType().equals("Passage")) {

                                        Passage p = (Passage) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification().getFragment();

                                        paragraph3.add(p.getText());
                                    }
                                    //If Modification type = Case
                                    else if(legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification().getType().equals("Case")) {
