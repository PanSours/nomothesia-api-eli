        ...
        <div>
            <div class="row" style="border-radius:5px; width: 100%">
                <div class="col-md-4" style="height: 20px; width: 40%; background-color: #005983">
                    <div style="font-family: 'Comfortaa', cursive; text-align: center; font-size: 15px; color: white;">
                        ΝΔ
                    </div>
                </div>
...
<div class="row">
    <div>
        <div class="row" style="border-radius:5px; width: 100%">
            <div class="col-md-4" style="height: 20px; width: 40%; background-color: #005983">
                <div style="font-family: 'Comfortaa', cursive; text-align: center; font-size: 15px; color: white;">ΝΔ
                </div>
            </div>
            <div class="col-md-4" style="height: 20px; width: 20%; background-color: green;">
                <div style="font-family: 'Comfortaa', cursive; text-align: center; font-size: 15px; color: white;">
            ...
            <div class="col-md-4" style="height: 20px; width: 10%; background-color: #1ab7ea">
                <div style="font-family: 'Comfortaa', cursive; text-align: center; font-size: 15px; color: white;"> ΟΙΚ.
                    (ΠΑΣΟΚ,ΝΔ,ΛΑΟΣ)
                </div>
            </div>
            <div class="col-md-4" style="height:20px; width: 20%; background-color: #005983">
    ...
    <br/>
    <br/>
    <div style="font-family: 'Comfortaa', cursive; text-align: justify; font-size: 15px;"><spring:message
