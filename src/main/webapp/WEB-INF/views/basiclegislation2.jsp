                ...
                <div class="col-md-9">
                    ...
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#text" aria-controls="home" role="tab"
                                                                      data-toggle="tab"><spring:message code="basic.text"/></a>
                            </li>
                            <li role="presentation"><a href="#citations" aria-controls="profile" role="tab"
                                                       data-toggle="tab"><spring:message code="basic.cit"/></a></li>
                            <li role="presentation"><a href="#list" aria-controls="messages" role="tab"
                                                       data-toggle="tab"><spring:message code="basic.content"/></a></li>
                            <li role="presentation"><a href="#timeline" aria-controls="settings" role="tab"
                                                       data-toggle="tab"><spring:message code="basic.timeline"/></a></li>
                            <li role="presentation"><a href="#images" aria-controls="images" role="tab"
                                                       data-toggle="tab"><spring:message code="basic.images"/></a></li>
                            <li role="presentation"><a href="#problems" aria-controls="problems" role="tab"
                                                       data-toggle="tab"><spring:message code="basic.problems"/></a></li>
                            <div id="share-buttons">
                                <li style="display: inline;">
                                    <!-- Facebook -->
                                    <a href="http://www.facebook.com/sharer.php?u=${fn:replace(requestScope['javax.servlet.forward.request_uri'], pageContext.request.contextPath, '')}"
                                       target="_blank"><img src="/resources/images/facebook.png" alt="Facebook"/></a>
                                </li>
                                <li style="display: inline;">
                                    <!-- Twitter -->
                                    <a href="http://twitter.com/share?url=${fn:replace(requestScope['javax.servlet.forward.request_uri'], pageContext.request.contextPath, '')}"
                                       target="_blank"><img src="/resources/images/twitter.png" alt="Twitter"/></a>
                                </li>
                            </div>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="text">
                                <c:if test="${empty legaldoc.getChapters()}">
                                    <br/>
                                    <div class="alert alert-warning" role="alert"><strong><spring:message
                                            code="basic.notext"/></strong></div>
                                </c:if>
                                ...
                                <c:forEach var="chapter" items="${legaldoc.getChapters()}" varStatus="loop">
                                    ...
                                    <div id="chapter-${chapter.getId()}">
                                        <span style="text-align: center; font-size: 12px;"><h4><spring:message
                                                code="basic.chapter"/> ${chap_nums[chapter.getId()-1]}</h4></span>
                                        ...
                                        <c:forEach var="article" items="${chapter.getArticles()}" varStatus="loop">
                                            ...
                                            <div id="article-${article.getId()}">
                                                <span style="text-align: center; font-size: 12px;"><h4><spring:message
                                                        code="basic.article"/> ${article.getId()}</h4></span>
                                                ...
                                                <ol>
                                                    ...
                                                    <c:forEach var="paragraph" items="${article.getParagraphs()}"
                                                               varStatus="loop">
                                                        <c:set var="parcount" value="${parcount+1}"/>
                                                        <li${paragraph.getStatus() >= 1?' class="modification2"':"" }>
                                                            <div id="article-${article.getId()}-paragraph-${paragraph.getId()}"
                                                                 style="text-align: justify;">
                                                                <c:set var="pascount" value="0"/>
                                                                <c:forEach var="passage" items="${paragraph.getPassages()}"
                                                                           varStatus="loop">
                                                                        ...
                                                                        <div class="mod">
                                                                            <c:choose>
                                                                                <c:when test="${passage.getModification().getType() == 'Case'}">
                                                                                    <c:forEach var="passage3"
                                                                                               items="${passage.getModification().getFragment().getPassages()}"
                                                                                               varStatus="loop">
                                                                                        ${passage3.getText()}
                                                                                    </c:forEach>
                                                                                </c:when>
                                                                                ...
                                                                                <c:when test="${passage.getModification().getType() == 'Paragraph'}">
                                                                                    ...
                                                                                    <c:if test="${passage.getModification().getFragment().getCaseList().size() > 0}">
                                                                                        <ol class="special-list"
                                                                                            ...
                                                                                            <c:forEach var="case2"
                                                                                                       items="${passage.getModification().getFragment().getCaseList()}"
                                                                                                       varStatus="loop">
                                                                                                <c:forEach var="passage2"
                                                                                                           items="${case2.getPassages()}"
                                                                                                           varStatus="loop">
                                                                                ...
                                                                                <c:when test="${passage.getModification().getType() == 'Article'}">
                                                                                    <span style="text-align: center; font-size: 12px;"><h4><spring:message
                                                                                            code="basic.article"/> ${passage.getModification().getFragment().getId()}</h4></span>
                                                                                    <ol>
                                                                                        <c:forEach var="paragraph5"
                                                                                                   items="${passage.getModification().getFragment().getParagraphs()}"
                                                                                                   varStatus="loop">
                                                                                            <li>
                                                                                                <c:forEach var="passage5"
                                                                                                           items="${paragraph5.getPassages()}"
                                                                                                           varStatus="loop">
                                                                                                    ${passage5.getText()}
                                                                                                </c:forEach>
                                                                                                <c:if test="${paragraph5.getCaseList().size() > 0}">
                                                                                                    <ol class="special-list"
                                                                                                        ...
                                                                                                        <c:set var="casecount"
                                                                                                               value="0"/>
                                                                                                        <c:forEach var="case5"
                                                                                                                   items="${paragraph5.getCaseList()}"
                                                                                                                   varStatus="loop">
                                                                                                            <c:forEach
                                                                                                                    var="passage6"
                                                                                                                    items="${case5.getPassages()}"
                                                                                                                    varStatus="loop">
                                                                    ...
                                                                    <c:if test="${passage.getStatus() >= 1}">
                                                                        <c:if test="${passage.getStatus() ==2}">
                                                                            <span class="clickable" data-toggle="collapse"
                                                                                  id="${artcount}${parcount}${pascount}"
                                                                                  data-target=".${artcount}${parcount}${pascount}collapsed"
                                                                                  style="text-align:right;"><span
                                                                                    style="cursor: pointer;"
                                                                                    class="glyphicon glyphicon-transfer"
                                                                                    aria-hidden="true"></span></span>
                                                                            <c:set var="target_uri"
                                                                                   value="chapter/${chapcount}article/${artcount}/paragraph/${parcount}/passage/${pascount}"/>
                                                                            <div class="collapse out budgets ${artcount}${parcount}${pascount}collapsed"
                                                                                 style=" background-color: #FFCCCC; border: 6px solid; border-radius: 10px; border-color: #FFCCCC;">
                                                                                <c:forEach var="frag" items="${fragschanced}"
                                                                                           varStatus="loop">
                                                                ...
                                                                <ol class="special-list" style="list-style-type: none;">
                                                                    <c:set var="casecount" value="0"/>
                                                                    <c:forEach var="case1" items="${paragraph.getCaseList()}"
                                                                               varStatus="loop">
                                                                        <li ${case1.getStatus() >= 1?' class="modification"':"" }
                                                                                data-number="${ionian_nums[casecount]}">
                                                                            <c:forEach var="passage2"
                                                                                       items="${case1.getPassages()}"
                                                                                       varStatus="loop">
                                                                                ...
                                                                                <div class="mod">
                                                                                    <c:choose>
                                                                                        <c:when test="${case1.getModification().getType() == 'Case'}">
                                                                                            <c:forEach var="passage3"
                                                                                                       items="${case1.getModification().getFragment().getPassages()}"
                                                                                                       varStatus="loop">
                                                                                                ${passage3.getText()}
                                                                                            </c:forEach>
                                                                                        </c:when>
                                                                                            ...
                                                                                            <c:if test="${case1.getModification().getFragment().getCaseList().size() > 0}">
                                                                                                <ol class="special-list"
                                                                                                    ...
                                                                                                    <c:set var="casecount"
                                                                                                           value="0"/>
                                                                                                    <c:forEach var="case2"
                                                                                                               items="${case1.getModification().getFragment().getCaseList()}"
                                                                                                               varStatus="loop">
                                                                                                        <c:forEach
                                                                                                                var="passage2"
                                                                                                                items="${case2.getPassages()}"
                                                                                        ...
                                                                                        <c:when test="${case1.getModification().getType() == 'Article'}">
                                                                                            <span style="text-align: center; font-size: 12px;"><h4><spring:message
                                                                                                    code="basic.article"/> ${case1.getModification().getFragment().getId()}</h4></span>
                                                                                            <ol>
                                                                                                <c:forEach var="paragraph5"
                                                                                                           items="${case1.getModification().getFragment().getParagraphs()}"
                                                                                                           varStatus="loop">
                                                                                                    <li>
                                                                                                        <c:forEach
                                                                                                                var="passage5"
                                                                            ...
                                                                            <c:if test="${case1.getStatus() >= 1}">
                                                                                <c:if test="${case1.getStatus() ==2}">
                                                                                    <span class="clickable"
                                                                                          ...
                                                                                          id="${artcount}${parcount}0${casecount+1}"
                                                                                          data-target=".${artcount}${parcount}0${casecount+1}collapsed"
                                                                                          style="text-align:right;"><span
                                                                                            style="cursor: pointer;"
                                                                                            class="glyphicon glyphicon-transfer"
                                                                                            aria-hidden="true"></span></span>
                                                                                    <c:set var="target_uri"
                                                                                           value="chapter/${chapcount}article/${artcount}/paragraph/${parcount}/case/${casecount+1}"/>
                                                                                    <div class="collapse out budgets ${artcount}${parcount}0${casecount+1}collapsed"
                                                                                         style=" background-color: #FFCCCC; border: 6px solid; border-radius: 10px; border-color: #FFCCCC;">
                                                                                        <c:forEach var="frag"
                                                                                                   items="${fragschanced}"
                                                                                                   varStatus="loop">
                                                                                            <c:if test="${fn:endsWith(frag.getURI(),target_uri)}">
                                                                                                <c:forEach var="passage23"
                                                                                                           items="${frag.getPassages()}"
                                                                                                           varStatus="loop">
                                                                                                    ${passage23.getText()}
                                                                                                </c:forEach>
                                                                                            </c:if>
                                                            ...
                                                            <c:if test="${paragraph.getStatus() >= 1}">
                                                                <c:if test="${paragraph.getStatus() ==2}">
                                                                    <span class="clickable" data-toggle="collapse"
                                                                          id="${parcount}" data-target=".${parcount}collapsed"
                                                                          style="text-align:right;"><span
                                                                            style="cursor: pointer;"
                                                                            class="glyphicon glyphicon-transfer"
                                                                            aria-hidden="true"></span></span>
                                                                    <c:set var="target_uri"
                                                                           value="chapter/${chapcount}article/${artcount}/paragraph/${parcount}"/>
                                                                    <div class="collapse out budgets ${parcount}collapsed"
                                                                         style=" background-color: #FFCCCC; padding: 6px; border-radius: 10px;">
                                                                        <c:forEach var="frag" items="${fragschanced}"
                                                                                   varStatus="loop">
                                                                            <c:if test="${fn:endsWith(frag.getURI(),target_uri)}">
                                                                                <c:forEach var="passage24"
                                                                                           items="${frag.getPassages()}"
                                                                                           varStatus="loop">
                                                                                    ${passage24.getText()}
                                                                                </c:forEach>
                                                                                <c:if test="${frag.getCaseList().size() > 0}">
                                                                                    <ol class="special-list"
                                                                                        style="list-style-type: none;">
                                                                                        <c:set var="casecount" value="0"/>
                                                                                        <c:forEach var="case22"
                                                                                                   items="${frag.getCaseList()}"
                                                                                                   varStatus="loop">
                                                                                            <c:forEach var="passage22"
                                                                                                       items="${case22.getPassages()}"
                                                                                                       varStatus="loop">
                            ...
                            <div role="tabpanel" class="tab-pane" id="citations">
                                <c:if test="${not empty legaldoc.getCitations()}">
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-bordered" style="text-align: left;"
                                ...
                                <c:if test="${empty legaldoc.getCitations()}">
                                    <br/>
                                    <div class="alert alert-warning" role="alert"><strong><spring:message
                                            code="basic.nocitations"/></strong></div>
                                </c:if>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="list">
                                <ul id="messagescol">
                                    <c:forEach var="chapter" items="${legaldoc.getChapters()}" varStatus="loop">
                                        ...
                                        %>
                                        <li><a href="<c:url value="${legaldoc.getId()}/chapter/${chapter.getId()}"/>"
                                               target="_blank"> <spring:message code="basic.chapter"/> ${chapter.getId()} <c:if
                                                test="${not empty chapter.getTitle()}"> «${chapter.getTitle()}»</c:if></a>
                                            <ul>
                                                <c:forEach var="article" items="${chapter.getArticles()}" varStatus="loop">
                                                    ...
                                                    %>
                                                    <li>
                                                        <a href="<c:url value="${legaldoc.getId()}/chapter/${chapter.getId()}/article/${article.getId()}"/>"
                                                           target="_blank"> <spring:message
                                                                code="basic.article"/> ${article.getId()} <c:if
                                                                test="${not empty article.getTitle()}"> «${article.getTitle()}»</c:if></a>
                                                        <ul>
                                                            <c:forEach var="paragraph" items="${article.getParagraphs()}"
                                                                       varStatus="loop">
                                                                <% Paragraph p =
                                                                        (Paragraph) pageContext.getAttribute("paragraph");
                                                                ...
                                                                %>
                                                                <li>
                                                                    <a href="<c:url value="${legaldoc.getId()}/chapter/${chapter.getId()}/article/${uri1}"/>"
                                                                       target="_blank"><spring:message
                                                                            code="basic.par"/> ${paragraph.getId()}</a></li>
                                                            </c:forEach>
                                                        </ul>
                                                    </li>
                                                </c:forEach>
                                        ...
                                        <c:if test="${not empty legalmods}">
                                            ...
                                            <c:forEach var="legalmod" items="${legalmods}" varStatus="loop">
                                                <c:if test="${legalmod.getCompetenceGround().getTitle()!=currentTitle}">
                                                    ...
                                                    <tr class="clickable" data-toggle="collapse" id="mod"
                                                        data-target=".modcollapsed">
                                                        <td>${legalmod.getCompetenceGround().getPublicationDate()}</td>
                                                        <td>
                                                            <a href="${legalmod.getCompetenceGround().getURI()} ">${legalmod.getCompetenceGround().getTitle()}</a>
                                                            <span style="cursor: pointer;" class="glyphicon glyphicon-download"
                                                    ...
                                                    <td colspan="3">
                                                        <div class="table-responsive">
                                                            <table id="example2" class="table table-striped table-bordered"
                                                                   style="text-align: left;" cellspacing="0" width="100%">
                                                                <thead>
                                                                ...
                                                                <c:set var="modname"
                                                                       value="${fn:replace(legalmod.getTarget(),'paragraph',par)}"/>
                                                                <c:set var="modname"
                                                                       value="${fn:replace(modname,'passage',pas)}"/>
                                                                <c:set var="modname"
                                                                       value="${fn:replace(modname,'case',case2)}"/>
                                                                <c:set var="modname"
                                                                       value="${fn:replace(modname,'article',art)}"/>
                                                                <c:set var="modname"
                                                                       value="${fn:replace(modname,'chapter',chap)}"/>
                                                                    ...
                                                                    <td>
                                                                        <c:choose>
                                                                            <c:when test="${legalmod.getFragment().getType() == 'Case'}">
                                                                                <c:forEach var="passage13"
                                                                                           items="${legalmod.getFragment().getPassages()}"
                                                                                           varStatus="loop">
                                                                                    ${passage13.getText()}
                                                                                </c:forEach>
                                                                            </c:when>
                                                                            ...
                                                                            <c:when test="${legalmod.getFragment().getType() == 'Paragraph'}">
                                                                                ...
                                                                                <c:if test="${legalmod.getFragment().getCaseList().size() > 0}">
                                                                                    <ol style="list-style-type: lower-greek;">
                                                                                        <c:forEach var="case12"
                                                                                                   items="${legalmod.getFragment().getCaseList()}"
                                                                                                   varStatus="loop">
                                                                                            <c:forEach var="passage12"
                                                                                                       items="${case12.getPassages()}"
                                                                                                       varStatus="loop">
                            ...
                            <div role="tabpanel" class="tab-pane" id="images">
                                <c:if test="${not empty legaldoc.getImages()}">
                                    ...
                                    <c:forEach var="image" items="${legaldoc.getImages()}" varStatus="loop">
                                        ...
                                        <a href="/resources/images/leg/${image}" data-lightbox="roadtrip"><img width="200"
                                                                                                               src="/resources/images/leg/${image}"/>
                                        </a>
                                    </c:forEach>
                                </c:if>
                                <c:if test="${empty legaldoc.getImages()}">
                                    <div class="alert alert-warning" role="alert"><strong><spring:message
                                            code="basic.noimages"/></strong></div>
                                </c:if>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="problems">
                                ...
                                <c:if test="${not empty legaldoc.getIssues()}">
                                    <c:forEach var="issue" items="${legaldoc.getIssues()}" varStatus="loop">
                                        <div class="alert alert-danger" role="alert"><c:if
                                                test="${issue == 'mods'}"><spring:message code="basic.modissue"/></c:if><c:if
                                                test="${issue!='mods'}">${issue}</c:if></div>
                                    </c:forEach>
                                </c:if>
