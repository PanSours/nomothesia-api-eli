                        ...
                        <div role="tabpanel">
                            ...
                            <div class="tab-content" style="text-align:justify;">
                                <div role="tabpanel" class="tab-pane fade in active" id="byyear">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="example2" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><spring:message code="gazette.summary"/></td>
                                                    <td>1866 (<c:out value="${fn:substringBefore(186600/2593,'.')}"/>%)</td>
                                                    <td>2480 (<c:out value="${fn:substringBefore(248000/2593,'.')}"/>%)</td>
                                                    <td>2593</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <br/><br/>
                                    <div class="row">
                                        <div class="row" style="font-family: 'Comfortaa', cursive; text-align: center; font-size: 15px;"><spring:message code="stats.comment1"/></div>
                                        <div class="row" style="font-family: 'Comfortaa', cursive; text-align: center; font-size: 15px;"><spring:message code="stats.comment2"/></div>
                                    </div>
                                </div>
                        ...
                        <c:when test="${localeCode2 == 'el_GR' }">
                            "bLengthChange": false,
                                "oLanguage": {
                                    ...
                                    "sSearch": "Αναζήτηση",
                                    "oPaginate": {
                                        "sNext": "Επόμενη", "sPrevious": "Προηγούμενη"
                                    }
                                }
                            </c:when>
                        </c:choose>
